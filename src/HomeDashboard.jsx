...
        return (
          <div style={{ marginBottom: 20 }}>
            <div style={{ fontSize: 11, color: COLORS.gold, letterSpacing: 1, textTransform: 'uppercase', fontWeight: 700, marginBottom: 6 }}>Season Leaders</div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
              {LEADERS.map(card => (
...
             <button onClick={() => {
  const content = document.getElementById('stat-sheet-printable').innerHTML;
  const win = window.open('', '_blank');
  win.document.write(`<!DOCTYPE html><html><head><title>Season Stats</title><style>
