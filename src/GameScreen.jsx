...
      {/* Our side */}
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 10px', background: `linear-gradient(90deg, ${ourPrimary} 50%, #111 100%)`, height: '100%', minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 7, minWidth: 0, flex: 1 }}>
          {logo
            ? <img src={logo} alt="" style={{ width: 32, height: 32, borderRadius: 5, objectFit: 'cover', flexShrink: 0 }} />
            : <div style={{ width: 32, height: 32, borderRadius: 5, background: 'rgba(255,255,255,0.15)', flexShrink: 0 }} />}
          <span style={{ fontSize: 16, fontWeight: 900, color: '#e7b977', letterSpacing: 1.5, textTransform: 'uppercase', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{ourAbbr}</span>
        </div>
        <span style={{ fontSize: 32, fontWeight: 900, color: '#fff', lineHeight: 1, flexShrink: 0 }}>{ourScore}</span>
      </div>
      {/* Center */}
      <div style={{ width: 88, flexShrink: 0, background: '#0d0d0d', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 2, borderLeft: '1px solid #2a2a2a', borderRight: '1px solid #2a2a2a' }}>
        <img src={XOVR_LOGO} alt="" style={{ width: 24, height: 24, objectFit: 'contain', opacity: 0.9 }} />
        {isFinal ? (
          <div style={{ fontSize: 9, fontWeight: 800, color: '#ff3b30', letterSpacing: 1.5 }}>FINAL</div>
        ) : (
          <>
...
            <button onClick={onClockClick} style={{ fontSize: 14, fontWeight: 700, color: '#ff3b30', background: 'none', border: 'none', cursor: 'pointer', fontFamily: "'Courier New', monospace", letterSpacing: 1.5, padding: 0, lineHeight: 1, textShadow: '0 0 8px rgba(255,59,48,0.9)' }}>
...
        <span style={{ fontSize: 32, fontWeight: 900, color: '#fff', lineHeight: 1, flexShrink: 0 }}>{oppScore}</span>
        <div style={{ display: 'flex', alignItems: 'center', gap: 7, minWidth: 0, flex: 1, justifyContent: 'flex-end' }}>
          <span style={{ fontSize: 16, fontWeight: 900, color: oppSecondary, letterSpacing: 1.5, textTransform: 'uppercase', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{oppAbbr}</span>
          {oppLogo
            ? <img src={oppLogo} alt="" style={{ width: 32, height: 32, borderRadius: 5, objectFit: 'cover', flexShrink: 0 }} />
            : <div style={{ width: 32, height: 32, borderRadius: 5, background: oppPrimary, border: `1px solid ${oppSecondary}`, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 900, color: oppSecondary }}>{oppAbbr.slice(0,1)}</div>}
        </div>
      </div>
    </div>
  );
